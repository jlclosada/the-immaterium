...
const PLANS = [
  {
    ...
    price: 'Gratis',
    period: '',
    desc: 'Acceso a toda la comunidad y contenido público.',
    cta: 'Empezar gratis →',
    features: [
      'Acceso a ejércitos, lore y noticias',
      'Reseñas de batalla',
      'Army Builder gratuito',
      'Marketplace de miniaturas',
      'Perfil y facciones favoritas',
    ],
    notIncluded: [
  ...
  },
  {
    ...
    price: '4,99€',
    period: '/ guía',
    desc: 'Desbloquea guías avanzadas con pago único por contenido.',
    cta: 'Empezar con Premium →',
    features: [
      'Todo lo del plan Estándar',
      'Guías de pintura avanzadas',
      'Técnicas profesionales paso a paso',
      'Vídeos exclusivos de maestros pintores',
