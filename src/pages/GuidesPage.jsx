    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', flexWrap: 'wrap' }}>
          ...
          {guide.views > 0 && (
            <span style={{ fontSize: '0.72rem', color: isLight ? 'var(--text-dim)' : 'rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
          ...
          {guide.likes > 0 && (
            <span style={{ fontSize: '0.72rem', color: 'rgba(255,100,100,0.55)', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
