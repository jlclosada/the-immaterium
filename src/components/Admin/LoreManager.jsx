                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.5rem' }}>
                                        <input
                                            ...
                                            style={{ flex: 1, padding: '0.75rem', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: 'white' }}
                                        />
                                        <button
                                            type="button"
                                            onClick={addTag}
                ...
                <div style={{ display: 'grid', gap: '1rem' }}>
                    {loreEntries.map(lore => (
                        ...
                        >
                            ...
                            <div style={{ fontSize: '0.85rem', color: '#888', display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                                <span>Por {lore.author}</span>
                                {lore.views > 0 && (
